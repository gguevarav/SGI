						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Bitácoras<span class="caret"></span></a>
								<ul class="dropdown-menu" role="menu">
									...
									<li><a href="#">Bitácora de salidas de inventario</a></li>
						...
						<div class="container">
							<div class="row text-center">
								<div class="container-fluid">
									<div class="row">
										<div class="col-xs-6 ">
										<h1 class="text-center">Bitácora de salidas en el inventario</h1>
										</div>
										...
										<table class="table">
											...
											<tbody>
												<!-- Contenido de la tabla -->
													...
													<?php							
														$VerProductos = "SELECT * FROM registrosalida";
														// Hacemos la consulta
														$resultado = $mysqli->query($VerProductos);
															while ($row = mysqli_fetch_array($resultado)){
																?>
																<tr>
																<td><span id="idRegistroSalida<?php echo $row['idRegistroSalida'];?>"><?php echo $row['idRegistroSalida'] ?></span></td>
																<td><span id="FechaHoraEntrada<?php echo $row['idRegistroSalida'];?>"><?php echo $row['FechaHoraSalida'] ?></span></td>
																<td><span id="Producto<?php echo $row['idRegistroSalida'];?>"><!-- Acá mostraremos el nombre del producto a partir del id que se tiene en la tabla -->
																																		<?php							
																																			...
																																			echo $NombreProducto;
																																		?></span></td>
																<td><span id="CantidadSalida<?php echo $row['idRegistroSalida'];?>"><?php echo $row['CantidadSalida'] ?></span></td>
																<td><span id="DetalleSalida<?php echo $row['idRegistroSalida'];?>"><?php echo $row['DetalleSalida'] ?></span></td>
																<td><span id="UsuarioSalida<?php echo $row['idRegistroSalida'];?>"><?php echo $row['UsuarioSalida'] ?></span></td>
																</tr>
													<?php
															}
													?>
